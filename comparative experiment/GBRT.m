...
tr = templateTree('MaxNumSplits',1); % 定义单个决策树的模板
mdl = fitrensemble(Pn_train', Tn_train', 'Method', 'LSBoost', 'Learners', tr, 'NumLearningCycles', 10);
Tn_test = predict(mdl, Pn_test');
